export const core = {
  en: {
    ...
    maintenanceBody: "Bonus Academy is under maintenance. Please check back when the timer ends.",
    maintenanceSoon: "Soon",
    maintenanceUntil: "Check back at {time}",
    maintenancePassword: "Staff password",
    maintenanceUnlock: "Enter",
    maintenanceWrong: "Wrong password.",
    retry: "Try again",
    category: "Category",
    grade: "Grade",
    subject: "Subject",
  ...
  ar: {
    ...
    maintenanceBody: "بونص أكاديمي تحت الصيانة. يرجى العودة عند انتهاء المؤقت.",
    maintenanceSoon: "قريبًا",
    maintenanceUntil: "عد في {time}",
    maintenancePassword: "كلمة مرور الفريق",
    maintenanceUnlock: "دخول",
    maintenanceWrong: "كلمة المرور غير صحيحة.",
    retry: "حاول مرة أخرى",
    category: "الفئة",
    grade: "الصف",
    subject: "المادة",
