...
export function SupportLink({
  ...
  return (
    <a
      ...
      className={`inline-flex items-center gap-2 rounded-full border border-line-strong px-3.5 py-2 text-[13px] font-medium text-text hover:border-white/40 ${className}`}
    >
