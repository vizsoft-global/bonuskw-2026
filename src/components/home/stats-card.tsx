...
export function StatsCard({
  ...
  return (
    <div className="w-full overflow-hidden rounded-[12px] border border-line bg-surface px-[19px] py-[14px] lg:w-[363px] lg:shrink-0">
      <Link href="/my-space" className="mb-[10px] hidden items-center gap-[5px] lg:flex">
        <span className="text-[12px] font-semibold text-text">{labels.myStats}</span>
